Public Class Proveedores
    ...
    Public Function getCultivosByDescripcion(ByVal strDescripcion As String) As ADODB.Recordset
        Dim rs As New ADODB.Recordset
        Dim ssql As String = "   "
    ...
    Public Function Add_Renamed(ByVal strId As String, ByVal strDescripcion As String, ByVal strModulo As String) As Boolean
        Dim ssql As String = ""
    ...
    Public Function Edit(ByVal strId As String, ByVal strDescripcion As String) As Boolean
        Dim ssql As String = ""
        Dim boolResult As Boolean = False

        Try
            ssql = "update proveedores set "
            ssql = ssql & "descripcion=ltrim(rtrim('" & strDescripcion & "')) "
            ssql = ssql & "where id_proveedor='" & strId & "';"
            DBConn.Execute(ssql)
            boolResult = True
        Catch ex As Exception
            Dim dctException As New Dictionary(Of String, String)
