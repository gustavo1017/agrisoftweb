<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmCostosCosechas.aspx.vb" Inherits="AgrisoftWeb.UI.frmCostosCosechas" EnableEventValidation="false" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#txtCampana').keypress(function () {
                ...
                // Avoid two decimal separators
                if (event.which == 46 && ($(this).val().indexOf('.') != -1 || $(this).val().indexOf(',') != -1)) {
                    event.preventDefault();
                }
            });
        ...
        function setDatePickerControls() {
            ...
            $(".date").on("change", function () {
                ...
                $.ajax({
                    url: "frmCostosCosechas.aspx/GetTipoCambio",
                    method: "POST",
        ...
        function verifySelection() {
            var selectionId = '<%= Session("frmCostosCosechas_PreviousSelectedIndex") %>';
            ...
            <div id="dvInfo" runat="server">
                <div class="form-row">
                    <div class="col-0" style="width: 130px; text-align: right">
                        ...
                        <asp:Label ID="lblCultivo" runat="server" Text="Cultivo" CssClass="col-form-label-sm" Visible="false"></asp:Label>
                    </div>
                    <div class="col-2">
                        <asp:DropDownList ID="cboZonaTrabajo" runat="server" CssClass="form-control form-control-sm" OnSelectedIndexChanged="cboZonaTrabajo_SelectedIndexChanged" AutoPostBack="true" Width="280px"></asp:DropDownList>
                        <asp:DropDownList ID="cboCultivo" runat="server" CssClass="form-control form-control-sm" OnSelectedIndexChanged="cboCultivo_SelectedIndexChanged" AutoPostBack="true" Visible="false"></asp:DropDownList>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-0" style="width: 130px; text-align: right">
                        <asp:Label ID="lblActividad" runat="server" Text="Actividad" CssClass="col-form-label-sm" Visible="false"></asp:Label>
                    </div>
                    <div class="col-3">
                        <asp:DropDownList ID="cboActividad" runat="server" CssClass="form-control form-control-sm" Width="220px" Visible="false"></asp:DropDownList>
                    </div>
