<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Pages/MasterAgrisoftWeb.Master" CodeBehind="frmCostosProductosView.aspx.vb" Inherits="AgrisoftWeb.UI.frmCostosProductosView" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PagesContent" runat="server">
     <div class="form-row">
        <div class="col-12">
            <div id="Div2" runat="server" class="alert alert-info">
                <b><asp:Label ID="Label3" runat="server" Text="Compras"></asp:Label></b>
            </div>
        </div>
    </div>
        ...
        <div class="form-row">
            ...
            <div class="col-sm-2" style="padding-left:25px">
                <div style="padding-bottom: 10px;">
                    <asp:Button ID="btnNuevo" runat="server" Text="" OnClientClick="return showNewForm();" CssClass="btn btn-primary btn-sm" Width="105px" />
                </div>
                <div style="padding-bottom: 10px">
                    <asp:Button ID="btnModificar" runat="server" Text="" OnClientClick="return showEditForm();" CssClass="btn btn-primary btn-sm" Width="105px" />
                </div>
                <div style="padding-bottom: 10px">
    ...
    <script type="text/javascript">
        ...
        function showEditForm() {
            ...
            var w = $(window).width();
            var modalPage = "frmCostosProductos.aspx?Action=EDIT";
        ...
        function showNewForm() {
            ...
            var w = $(window).width();
            var modalPage = "frmCostosProductos.aspx?Action=NEW";
            var urlBase = location.href.substring(0, location.href.lastIndexOf("/") + 1);
            var url = urlBase + modalPage;
            var $dialog = $('<div></div>').html('<iframe style="border: 0px; " src="' + modalPage + '" width="100%" height="100%"></iframe>').dialog({
                autoOpen: false,
        ...
        function verifySelection() {
            var selectionId = '<%= Session("frmCostosProductosView_IdCosto") %>';
