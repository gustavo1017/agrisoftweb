<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmProveedores.aspx.vb" Inherits="AgrisoftWeb.UI.frmproveedores" %>
    ...
    <form id="form1" runat="server">
        <div style="font-size: small">
            <div class="form-row">
                ...
                <div class="col">
                    <asp:TextBox ID="txtId" runat="server" CssClass="form-control form-control-sm" MaxLength="11"></asp:TextBox>
                </div>
            </div>
            <div class="form-row">
                <div class="col-4">
