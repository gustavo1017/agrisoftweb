<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Pages/MasterAgrisoftWeb.Master" CodeBehind="frmMaquinas_view.aspx.vb" Inherits="AgrisoftWeb.UI.frmMaquinas_view" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PagesContent" runat="server">
     <div class="form-row">
        <div class="col-12">
            <div id="Div2" runat="server" class="alert alert-info">
                <b><asp:Label ID="Label3" runat="server" Text="Maquinaria y Bombas de Riego"></asp:Label></b>
            </div>
        </div>
    </div>
    <div style="padding-top: 20px">
        <div class="form-row">
            ...
            <div class="col-4">
                <asp:Button ID="btnBuscar" runat="server" Text="" OnClick="btnBuscar_Click" CssClass="btn btn-primary btn-sm" />
            </div>
        </div>
        ...
        <div class="row" style="padding-top: 10px">
            <div id="Frame3" style="height: 200px; overflow: scroll; float: left; position: relative; left: 0;" class="col-sm-6">
        ...
        <asp:HiddenField ID="hdnStr12124" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function verifySelection() {
            var selectionId = '<%= Session("frmMaquinasView_IdMaquina") %>';
        ...
        function showEditForm() {
            ...
            var modalPage = "frmMaquinas.aspx?Action=EDIT";
            ...
            var $dialog = $('<div></div>').html('<iframe style="border: 0px; " src="' + modalPage + '" width="100%" height="100%"></iframe>').dialog({
                ...
                height: 345,
                width: 425,
                title: document.getElementById('<%=hdnStr12124.ClientID%>').value,
                position: ['center', 20],
        ...
        function showNewForm() {
            ...
            var modalPage = "frmMaquinas.aspx?Action=NEW";
            var urlBase = location.href.substring(0, location.href.lastIndexOf("/") + 1);
            var url = urlBase + modalPage;
            var $dialog = $('<div></div>').html('<iframe style="border: 0px; " src="' + modalPage + '" width="100%" height="100%"></iframe>').dialog({
                autoOpen: false,
