<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Pages/MasterAgrisoftWeb.Master" CodeBehind="frmEtapasView.aspx.vb" Inherits="AgrisoftWeb.UI.frmEtapasView" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PagesContent" runat="server">
     <div class="form-row">
        <div class="col-12">
            <div id="Div2" runat="server" class="alert alert-info">
                <b><asp:Label ID="Label3" runat="server" Text="Etapas"></asp:Label></b>
            </div>
        </div>
    </div>
    <div style="padding-top: 20px">
        ...
        <div class="row" style="padding-top:10px">
            ...
            <div id="Frame4" class="col-sm-2">
                ...
                <div style="padding-bottom: 8px">
                    <asp:Button ID="btnExportarExcel" runat="server" Text="" OnClick="btnExportarExcel_Click" CssClass="btn btn-primary btn-sm" Width="95px" Visible="false" />
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <asp:HiddenField ID="hdnStr22" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function verifySelection() {
            var selectionId = '<%= Session("frmEtapasView_IdEtapa") %>';
        ...
        function showEditForm() {
            ...
            var modalPage = "frmEtapas.aspx?Action=EDIT";
            ...
            var $dialog = $('<div></div>').html('<iframe style="border: 0px; " src="' + modalPage + '" width="100%" height="100%"></iframe>').dialog({
                ...
                height: 350,
                width: 420,
                title: document.getElementById('<%=hdnStr22.ClientID%>').value,
                position: ['center', 20],
        ...
        function showNewForm() {
            ...
            var modalPage = "frmEtapas.aspx?Action=NEW";
            var urlBase = location.href.substring(0, location.href.lastIndexOf("/") + 1);
            var url = urlBase + modalPage;
            var $dialog = $('<div></div>').html('<iframe style="border: 0px; " src="' + modalPage + '" width="100%" height="100%"></iframe>').dialog({
                autoOpen: false,
