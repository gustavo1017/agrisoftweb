<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Pages/MasterAgrisoftWeb.Master" CodeBehind="frmActividades_View.aspx.vb" Inherits="AgrisoftWeb.UI.frmActividades_View" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PagesContent" runat="server">
      <div class="form-row">
        <div class="col-12">
            <div id="Div1" runat="server" class="alert alert-info">
                <b><asp:Label ID="Label2" runat="server" Text="Actividades"></asp:Label></b>
            </div>
        </div>
    </div>
    <div style="padding-top: 20px">
        ...
        <div class="row" style="padding-top: 10px">
            <div id="Frame3" style="width: 80%; height: 300px; overflow: scroll; float: left" class="col-sm-10">
        ...
        <asp:HiddenField ID="hdnStr23" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function verifySelection() {
            var selectionId = '<%= Session("frmActividadesView_IdActividad") %>';
        ...
        function showEditForm() {
            ...
            var modalPage = "frmActividades.aspx?Action=EDIT";
            ...
            var $dialog = $('<div></div>').html('<iframe style="border: 0px; " src="' + modalPage + '" width="100%" height="100%"></iframe>').dialog({
                ...
                width: 450,
                position: ['center', 20],
                title: document.getElementById('<%=hdnStr23.ClientID%>').value,
        ...
        function showNewForm() {
            ...
            var modalPage = "frmActividades.aspx?Action=NEW";
            var urlBase = location.href.substring(0, location.href.lastIndexOf("/") + 1);
            var url = urlBase + modalPage;
            var $dialog = $('<div></div>').html('<iframe style="border: 0px; " src="' + modalPage + '" width="100%" height="100%"></iframe>').dialog({
                autoOpen: false,
