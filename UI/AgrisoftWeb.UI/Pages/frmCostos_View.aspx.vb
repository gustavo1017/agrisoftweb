...
Public Class frmCostos_View
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            If Session("frmCostos_Action") = "NEW" Or Session("frmCostos_Action") = "EDIT" Then
                Refresh()
            End If
        End If
    End Sub
    ...
    Protected Sub btnBorradoTotal_Click(sender As Object, e As EventArgs)
        ...
        If Session("frmCostosView_NumeroParte") Is Nothing Then
            Exit Sub
        End If
        ...
        If Session("frmCostosView_nRecords") IsNot Nothing Then
            nRecords = Convert.ToInt64(Session("frmCostosView_nRecords"))
        End If
    ...
    Protected Sub btnEliminar_Click(sender As Object, e As EventArgs)
        If Session("frmCostosView_IdCosto") Is Nothing Then
            Exit Sub
        End If
    ...
    Protected Sub grilla_SelectedIndexChanged(sender As Object, e As EventArgs)
        For Each row As GridViewRow In grilla.Rows
            If row.RowIndex = grilla.SelectedIndex Then
                ...
                Session.Add("frmCostosView_IdCosto", row.Cells(0).Text)
                Session.Add("frmCostos_Codigo", row.Cells(0).Text)
                Session.Add("frmCostosView_NumeroParte", row.Cells(2).Text)
                'Session.Add("frmCostos_StrIdenlace", row.Cells(0).Text)
                'Session.Add("frmCostosView_ParametroSistema", row.Cells(4).Text)
            Else
    ...
    Public Function Delete() As Boolean
        Dim idCosto As String = Session("frmCostosView_IdCosto").ToString()
    ...
    Private Function DeleteTotal() As Boolean
        ...
        Dim bolResult As Boolean = False
        Dim nroParte As String = Session("frmCostosView_NumeroParte").ToString()
        Dim objBL As New GenericMethods("Fundo0")
        Dim DBconn As New ADODB.Connection
    ...
    Private Sub cargarDatosGrilla(ByVal sField As String, ByVal sText As String, Optional ByVal sText2 As String = "", Optional ByVal sOrder As String = "")
        ...
        Session.Add("frmCostosView_nRecords", 0)
        ...
        Session.Add("frmCostosView_IdCosto", Nothing)
        'End If

        Session.Add("frmCostos_Codigo", Nothing)
        Session.Add("frmCostos_StrIdenlace", Nothing)
        Session.Add("frmCostos_Action", "")
        Session.Add("frmCostosView_nRecords", nRecords)
        Session.Add("frmCostosView_NumeroParte", Nothing)
    ...
    Private Function GetSqlQuery(ByVal sField As String, ByVal sText As String, ByVal sText2 As String, ByVal sOrder As String) As String
        ...
        Dim sCantidadRows As String = "100"
