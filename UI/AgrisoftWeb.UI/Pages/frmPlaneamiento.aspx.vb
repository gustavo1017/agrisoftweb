...
Public Class frmPlaneamiento
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Session("frmPlaneamiento_blnPasa1") = Nothing Then
        ...
        If Not Page.IsPostBack() Then
            ...
            Select Case UCase(strAction)
                Case "NEW"
                    CargarFecha()
                    Session("frmPlaneamiento_Action") = "NEW"
                Case "EDIT"
                    ...
                    Session("frmPlaneamiento_Action") = "EDIT"
            End Select
    ...
    Protected Sub lvwAsientos_RowDataBound(sender As Object, e As GridViewRowEventArgs)
        Select Case e.Row.RowType
            Case DataControlRowType.Header
                ...
                e.Row.Cells(10).Text = Resource1.str3005 'Resource1.str3005
    ...
    Protected Sub lvwAsientos_SelectedIndexChanged(sender As Object, e As EventArgs)
        Dim MatrizAC() As Object = Session("frmPlaneamiento_MatrizAC")
        Dim MatrizAx() As Object = Session("frmPlaneamiento_MatrizAx")
        Dim MatrizCm() As Object = Session("frmPlaneamiento_MatrizCm")
        Dim MatrizMq() As Object = Session("frmPlaneamiento_MatrizMq")
        Dim MatrizCc() As Object = Session("frmPlaneamiento_MatrizCc")
        Dim MatrizPr() As Object = Session("frmPlaneamiento_MatrizPr")
        Dim MatrizTd() As Object = Session("frmPlaneamiento_MatrizTd")
        Dim MatrizCt() As Object = Session("frmPlaneamiento_MatrizCt")
        Dim MatrizCp() As Object = Session("frmPlaneamiento_MatrizCp")

        Dim currentIndex As Integer = lvwAsientos.SelectedIndex
        Dim PreviousIndex As Integer = Convert.ToInt32(Session("frmPlaneamiento_PreviousSelectedIndex"))

        'Verify if a different row was selected
        If currentIndex = PreviousIndex Then
            Session("frmPlaneamiento_PreviousSelectedIndex") = currentIndex
            Exit Sub
        End If
        ...
        Session.Add("frmPlaneamiento_PreviousSelectedIndex", currentIndex)
        ...
        MatrizAx = Session("frmPlaneamiento_MatrizAx")
        ...
        MatrizTd = Session("frmPlaneamiento_MatrizTd")
        ...
        MatrizCm = Session("frmPlaneamiento_MatrizCm")
        cboActividad.SelectedIndex = fBuscarPosCodEnMatriz(MatrizCm, gRow.Cells(12).Text)

        MatrizAC = Session("frmPlaneamiento_MatrizAC")
        ...
        MatrizMq = Session("frmPlaneamiento_MatrizMq")
        MatrizCc = Session("frmPlaneamiento_MatrizCc")
        MatrizPr = Session("frmPlaneamiento_MatrizPr")
        MatrizCp = Session("frmPlaneamiento_MatrizCp")
        ...
        Session("frmPlaneamiento_IdCosto") = gRow.Cells(18).Text
    End Sub
    ...
    Protected Sub cboCodanx_SelectedIndexChanged(sender As Object, e As EventArgs)
        ...
        Dim MatrizAC() As Object = Session("frmPlaneamiento_MatrizAC")
        Dim MatrizPC() As Object = Session("frmPlaneamiento_MatrizPC")
        Dim MatrizPTC() As Object = Session("frmPlaneamiento_MatrizPTC")
    ...
    Protected Sub cboTipoCosto_SelectedIndexChanged(sender As Object, e As EventArgs)
        ...
        Select Case UCase(MatrizAC(cboTipoCosto.SelectedIndex))
            ...
            Case "R"
                ...
                lblAvance.Text = Resource1.str10590  'Resource1.str10590
            ...
            Case "C" : dvInfo.Visible = False
                ...
                lblRecurso.Text = Resource1.str544 'Resource1.str544
    ...
    Protected Sub cboZonaTrabajo_SelectedIndexChanged(sender As Object, e As EventArgs)
        Dim MatrizCa As Object = Session("frmPlaneamiento_MatrizCa")
    ...
    Protected Sub cmdModificar_Click(sender As Object, e As EventArgs)
        ...
        If Session("frmPlaneamiento_IdCosto") = Nothing Then
            Exit Sub
        End If

        Dim idCosto As String = Session("frmPlaneamiento_IdCosto")
        Dim dtContent As New DataTable()
        dtContent = Session("frmPlaneamiento_Datatable")
        ...
        Dim MatrizCt() As Object = Session("frmPlaneamiento_MatrizCt")
        Dim MatrizCp() As Object = Session("frmPlaneamiento_MatrizCp")
        Dim strIdCosto As String = Session("frmPlaneamiento_IdCosto").ToString()
        ...
        Session.Add("frmPlaneamiento_Datatable", dtContent)
        lvwAsientos.DataSource = dtContent
        lvwAsientos.DataBind()
        pSumaMontos()
        'Session("frmPlaneamiento_PreviousSelectedIndex") = -1
    End Sub
    ...
    Protected Sub cmdEliminar_Click(sender As Object, e As EventArgs)
        ...
        Session("frmPlaneamiento_PreviousSelectedIndex") = -1
        Session("frmPlaneamiento_Datatable") = dtContent
        lvwAsientos.DataSource = dtContent
        lvwAsientos.DataBind()
        pSumaMontos()
    End Sub
    ...
    Protected Sub btnGrabar_Click(sender As Object, e As EventArgs)
        ...
        If lvwAsientos.Rows.Count = 0 Then
            dvMessage.Visible = True
            dvMessage.Attributes.Add("class", "alert alert-danger")
            lblResults.Text = Resource1.str99999981 'Resource1.str99999981
            Exit Sub
        End If

        Dim MatrizProv() As Object = Session("frmPlaneamiento_MatrizProv")
        ...
        If txtCicloPeriodo.Text.Trim().Length = 0 Then
            GetCorrelativo()
        End If
    ...
    Private Sub pInsertarRegistro(ByVal IdZonaTrabajo As String, ByVal IdActividad As String, ByVal IdProducto As String, ByVal IdMaquina As String, ByVal IdPersonal As String, ByVal cantidad As Double, ByVal CostoUnitario As Double, ByVal MontoStandar As Double, ByVal campana As Double, ByVal tc As Short, ByVal TipoCambio As Double, ByVal numeroparte As String, ByVal tipocosto As String, ByVal fecha As Date, ByVal IdCosto As String, ByVal IdProveedor As String, ByVal sObservaciones As String, ByVal Avance As String)
        ...
        Else
            IdCosto = Session("frmPlaneamiento_Codigo").ToString()
    ...
    Private Sub Limpia()
        ...
        TotCantidad.Text = ""
        TotMonto.Text = ""
        Session("frmPlaneamiento_Datatable") = Nothing
    End Sub
    ...
    Private Sub CargarCombo(ByRef ssql As String, ByRef idField As String, ByRef Desc As String, ByRef Cbo As DropDownList)
        ...
        While Not adoTabla.EOF
            ...
            Dim STRID As String = Session("frmPlaneamiento_STRID")
            If adoTabla.Fields(idField).Value = STRID Then intOrden = i
            i = i + 1
            adoTabla.MoveNext()
        End While

        Session("frmPlaneamiento_MatrizPC") = MatrizPC
        Session("frmPlaneamiento_MatrizPTC") = MatrizPTC
        Session("frmPlaneamiento_MatrizCt") = MatrizCt
        Session("frmPlaneamiento_MatrizAx") = MatrizAx
        Session("frmPlaneamiento_MatrizCa") = MatrizCa
        Session("frmPlaneamiento_MatrizTd") = MatrizTd
        Session("frmPlaneamiento_MatrizCc") = MatrizCc
        Session("frmPlaneamiento_MatrizMq") = MatrizMq
        Session("frmPlaneamiento_MatrizCp") = MatrizCp
        Session("frmPlaneamiento_MatrizPr") = MatrizPr
        Session("frmPlaneamiento_MatrizAC") = MatrizAC
        Session("frmPlaneamiento_MatrizCm") = MatrizCm
        Session("frmPlaneamiento_MatrizProv") = MatrizProv
    ...
    Private Sub pSumaMontos()
        ...
        dt = Session("frmPlaneamiento_Datatable")
    ...
    Private Sub AddRecord()
        ...
        Dim MatrizCt() As Object = Session("frmPlaneamiento_MatrizCt")
        Dim MatrizCp() As Object = Session("frmPlaneamiento_MatrizCp")
        Dim strIdCosto As String = Session("frmPlaneamiento_IdCosto")
        ...
        Session("frmPlaneamiento_PreviousSelectedIndex") = -1
        Session("frmPlaneamiento_Datatable") = dt
    ...
    Function getRecord() As Boolean
        Dim StrIdenlace As String = Session("frmPlaneamiento_Codigo")
        ...
        If Not RS.EOF Then
            ...
            Dim MatrizProv() As Object = Session("frmPlaneamiento_MatrizProv")
            'Session.Add("frmPlaneamiento_provDesc") = provDesc
