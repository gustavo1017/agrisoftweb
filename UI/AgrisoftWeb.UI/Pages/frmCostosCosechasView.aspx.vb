...
Public Class frmCostosCosechasView
    Inherits BasePage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            If Session("frmCostosCosechas_Action") = "NEW" Or Session("frmCostosCosechas_Action") = "EDIT" Then
                Refresh()
            End If
        End If
    End Sub
    ...
    Protected Sub btnBorradoTotal_Click(sender As Object, e As EventArgs)
        If Session("frmCostosCosechasView_NumeroParte") Is Nothing Then
            Exit Sub
        End If

        Dim nRecords As Long = 0
        If Session("frmCostosCosechasView_nRecords") IsNot Nothing Then
            nRecords = Convert.ToInt64(Session("frmCostosCosechasView_nRecords"))
        End If
    ...
    Protected Sub btnEliminar_Click(sender As Object, e As EventArgs)
        If Session("frmCostosCosechasView_IdCosto") Is Nothing Then
            Exit Sub
        End If
    ...
    Protected Sub btnExportarExcel_Click(sender As Object, e As EventArgs)
        ...
        Session.Add("frmExportParametros_ParamExport", "COSECHAS")
    ...
    Protected Sub grilla_RowDataBound(sender As Object, e As GridViewRowEventArgs)
        Select Case e.Row.RowType
            Case DataControlRowType.Header
                ...
                e.Row.Cells(9).Text = Resource1.str101
    ...
    Protected Sub grilla_SelectedIndexChanged(sender As Object, e As EventArgs)
        For Each row As GridViewRow In grilla.Rows
            If row.RowIndex = grilla.SelectedIndex Then
                ...
                Session.Add("frmCostosCosechasView_IdCosto", row.Cells(0).Text)
                Session.Add("frmCostosCosechas_Codigo", row.Cells(0).Text)
                Session.Add("frmCostosCosechasView_NumeroParte", row.Cells(2).Text)
                'Session.Add("frmCostosCosechas_StrIdenlace", row.Cells(0).Text)
                'Session.Add("frmCostosCosechasView_ParametroSistema", row.Cells(4).Text)
            Else
    ...
    Public Function Delete() As Boolean
        Dim idCosto As String = Session("frmCostosCosechasView_IdCosto").ToString()
    ...
    Private Function DeleteTotal() As Boolean
        ...
        Dim bolResult As Boolean = False
        Dim nroParte As String = Session("frmCostosCosechasView_NumeroParte").ToString()
        Dim objBL As New GenericMethods("Fundo0")
        Dim DBconn As New ADODB.Connection
    ...
    Private Sub cargarDatosGrilla(ByVal sField As String, ByVal sText As String, Optional ByVal sText2 As String = "", Optional ByVal sOrder As String = "")
        ...
        Session.Add("frmCostosCosechasView_nRecords", 0)
        ...
        Session.Add("frmCostosCosechasView_IdCosto", Nothing)
        'End If

        Session.Add("frmCostosCosechas_Codigo", Nothing)
        Session.Add("frmCostosCosechas_StrIdenlace", Nothing)
        Session.Add("frmCostosCosechas_Action", "")
        Session.Add("frmCostosCosechasView_nRecords", nRecords)
        Session.Add("frmCostosCosechasView_NumeroParte", Nothing)
    ...
    Private Sub LoadPageResources()
        ...
        hdnStr89.Value = Resource1.str62
