...
Public Class frmCostosProductos
    Inherits BasePage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Session("FrmCostosProductos_blnPasa1") = Nothing Then
        ...
        If Not Page.IsPostBack() Then
            ...
            Select Case UCase(strAction)
                Case "NEW"
                    CargarFecha()
                    Session("frmCostosProductos_Action") = "NEW"
                Case "EDIT"
                    ...
                    Session("frmCostosProductos_Action") = "EDIT"
            End Select
    ...
    Protected Sub lvwAsientos_RowDataBound(sender As Object, e As GridViewRowEventArgs)
        Select Case e.Row.RowType
            Case DataControlRowType.Header
                ...
                e.Row.Cells(6).Text = Resource1.str516
                e.Row.Cells(7).Text = Resource1.str3007
                e.Row.Cells(8).Text = Resource1.str3008
                e.Row.Cells(9).Text = Resource1.str3009
                e.Row.Cells(10).Text = Resource1.str541
                e.Row.Cells(11).Text = Resource1.str3005 'Resource1.str3005
                'e.Row.Cells(11).Text = Resource1.str3005
                'str3005

                e.Row.Cells(12).Text = Resource1.str99999982
                'str99999982
                e.Row.Cells(12).Text = Resource1.str99999982


                e.Row.Cells(13).Text = Resource1.str99999983
                e.Row.Cells(14).Text = Resource1.str99999984
                e.Row.Cells(15).Text = Resource1.str60
                e.Row.Cells(16).Text = Resource1.str10003
                e.Row.Cells(17).Text = Resource1.str211
                e.Row.Cells(18).Text = Resource1.str315
                e.Row.Cells(19).Text = Resource1.str315
            ...
            Case DataControlRowType.DataRow
                ...
                e.Row.Cells(9).Text = Convert.ToDecimal(e.Row.Cells(9).Text, CultureInfo.InvariantCulture).ToString("###0.00", CultureInfo.InvariantCulture)
    ...
    Protected Sub lvwAsientos_SelectedIndexChanged(sender As Object, e As EventArgs)
        Dim MatrizAC() As Object = Session("FrmCostosProductos_MatrizAC")
        Dim MatrizAx() As Object = Session("FrmCostosProductos_MatrizAx")
        Dim MatrizCm() As Object = Session("FrmCostosProductos_MatrizCm")
        Dim MatrizMq() As Object = Session("FrmCostosProductos_MatrizMq")
        Dim MatrizCc() As Object = Session("FrmCostosProductos_MatrizCc")
        Dim MatrizPr() As Object = Session("FrmCostosProductos_MatrizPr")
        Dim MatrizTd() As Object = Session("FrmCostosProductos_MatrizTd")
        Dim MatrizCt() As Object = Session("FrmCostosProductos_MatrizCt")
        Dim MatrizCp() As Object = Session("FrmCostosProductos_MatrizCp")

        Dim currentIndex As Integer = lvwAsientos.SelectedIndex
        Dim PreviousIndex As Integer = Convert.ToInt32(Session("FrmCostosProductos_PreviousSelectedIndex"))

        'Verify if a different row was selected
        If currentIndex = PreviousIndex Then
            Session("FrmCostosProductos_PreviousSelectedIndex") = currentIndex
            Exit Sub
        End If
        ...
        Session.Add("FrmCostosProductos_PreviousSelectedIndex", currentIndex)
        ...
        txtTC.Text = gRow.Cells(15).Text

        'index = fBuscarPosCodEnMatriz(MatrizCt, gRow.Cells(18).Text)
        If cboCultivo.SelectedIndex <> index Then
            'cboCultivo.SelectedIndex = index
            'cboCultivo_SelectedIndexChanged(Nothing, Nothing)
        End If

        MatrizAx = Session("FrmCostosProductos_MatrizAx")
        'index = fBuscarPosCodEnMatriz(MatrizAx, gRow.Cells(12).Text)
        ...
        MatrizTd = Session("FrmCostosProductos_MatrizTd")
        'index = fBuscarPosCodEnMatriz(MatrizTd, gRow.Cells(17).Text)
        If cboEtapa.SelectedIndex <> index Then
            'cboEtapa.SelectedIndex = index
            'cboEtapa_SelectedIndexChanged(Nothing, Nothing)
        End If

        MatrizCm = Session("FrmCostosProductos_MatrizCm")
        'cboActividad.SelectedIndex = fBuscarPosCodEnMatriz(MatrizCm, gRow.Cells(12).Text)

        MatrizAC = Session("FrmCostosProductos_MatrizAC")
        index = fBuscarPosCodEnMatriz(MatrizAC, gRow.Cells(11).Text)
        ...
        MatrizMq = Session("FrmCostosProductos_MatrizMq")
        MatrizCc = Session("FrmCostosProductos_MatrizCc")
        MatrizPr = Session("FrmCostosProductos_MatrizPr")
        MatrizCp = Session("FrmCostosProductos_MatrizCp")
        ...
        If cboCodanx.SelectedIndex <> index Then
            'cboCodanx.SelectedIndex = index
            'cboCodanx_SelectedIndexChanged(Nothing, Nothing)
        End If

        txtCampana.Text = gRow.Cells(10).Text
        txtCantidad.Text = gRow.Cells(7).Text
        txtCostoUnitarioStandar.Text = gRow.Cells(8).Text
        txtMontoStandar.Text = gRow.Cells(9).Text
        txtAvance.Text = gRow.Cells(20).Text
        Session("FrmCostosProductos_IdCosto") = gRow.Cells(19).Text
    End Sub
    ...
    Protected Sub cboCodanx_SelectedIndexChanged(sender As Object, e As EventArgs)
        ...
        Dim MatrizAC() As Object = Session("FrmCostosProductos_MatrizAC")
        Dim MatrizPC() As Object = Session("FrmCostosProductos_MatrizPC")
        Dim MatrizPTC() As Object = Session("FrmCostosProductos_MatrizPTC")
    ...
    Protected Sub cboCultivo_SelectedIndexChanged(sender As Object, e As EventArgs)
        ...
        Dim MatrizCt() As Object = Session("FrmCostosProductos_MatrizCt")
        CargarCombo("SELECT ID_zonatrabajo, Descripcion, campana FROM ZONA_TRABAJO  where tipo='C' and Id_Cultivo = '" & MatrizCt(cboCultivo.SelectedIndex) & "' ORDER BY DESCRIPCION", "ID_ZONATRABAJO", "DESCRIPCION", cboZonaTrabajo)
    End Sub

    Protected Sub cboEtapa_SelectedIndexChanged(sender As Object, e As EventArgs)
        cboActividad.Items.Clear()
        Dim MatrizTd() As Object = Session("FrmCostosProductos_MatrizTd")
        CargarCombo("SELECT ID_actividad, Descripcion FROM Actividades Where Id_Etapa = '" & MatrizTd(cboEtapa.SelectedIndex) & "' ORDER BY DESCRIPCION", "ID_actividad", "DESCRIPCION", cboActividad)
    End Sub
    ...
    Protected Sub cboZonaTrabajo_SelectedIndexChanged(sender As Object, e As EventArgs)
        Dim MatrizCa As Object = Session("FrmCostosProductos_MatrizCa")
        txtCampana.Text = MatrizCa(cboZonaTrabajo.SelectedIndex)
    End Sub
    ...
    Protected Sub cmdModificar_Click(sender As Object, e As EventArgs)
        ...
        If Session("FrmCostosProductos_IdCosto") = Nothing Then
            Exit Sub
        End If

        Dim idCosto As String = Session("FrmCostosProductos_IdCosto")
        Dim dtContent As New DataTable()
        dtContent = Session("FrmCostosProductos_Datatable")
        ...
        Dim MatrizTd() As Object = Session("FrmCostosProductos_MatrizTd")
        Dim MatrizCt() As Object = Session("FrmCostosProductos_MatrizCt")
        Dim strIdCosto As String = Session("FrmCostosProductos_IdCosto").ToString()
        ...
        row.Item("Proveedor") = cboProveedor.Text
        row.Item(6) = cboCodanx.Text
        row.Item(7) = montoCantidad.ToString("###0.00", CultureInfo.InvariantCulture)
        row.Item(8) = montoCUnitario.ToString("###0.00", CultureInfo.InvariantCulture)
        row.Item(9) = (montoCantidad * montoCUnitario).ToString("###0.00", CultureInfo.InvariantCulture)
        row.Item(10) = txtCampana.Text
        row.Item(11) = MatrizAC(cboTipoCosto.SelectedIndex)
        row.Item(12) = "GASTGEN"
        row.Item(13) = "000001"

        Select Case Mid(row.Item(11), 1, 1)
            Case "I"
                row.Item(14) = MatrizCc(cboCodanx.SelectedIndex)
            Case "M", "R"
                row.Item(14) = MatrizMq(cboCodanx.SelectedIndex)
            Case "H"
                row.Item(14) = MatrizPr(cboCodanx.SelectedIndex)
        End Select

        row.Item(15) = txtTC.Text
        row.Item(16) = CStr(cboMoneda.SelectedIndex)
        row.Item(17) = "NA0"
        row.Item(18) = "COSTIN"
        row.Item(19) = strIdCosto
        row.Item(20) = IIf(String.IsNullOrEmpty(txtAvance.Text.Trim()), "0", txtAvance.Text.Trim())


        Session.Add("FrmCostosProductos_Datatable", dtContent)
        lvwAsientos.DataSource = dtContent
        lvwAsientos.DataBind()
        pSumaMontos()
        'Session("FrmCostosProductos_PreviousSelectedIndex") = -1
    End Sub
    ...
    Protected Sub cmdEliminar_Click(sender As Object, e As EventArgs)
        ...
        Session("FrmCostosProductos_PreviousSelectedIndex") = -1
        Session("FrmCostosProductos_Datatable") = dtContent
        lvwAsientos.DataSource = dtContent
        lvwAsientos.DataBind()
        pSumaMontos()
    End Sub
    ...
    Protected Sub btnGrabar_Click(sender As Object, e As EventArgs)
        ...
        Dim MatrizProv() As Object = Session("FrmCostosProductos_MatrizProv")
        ...
        For Each row As GridViewRow In lvwAsientos.Rows
            ...
            cantidad = Double.Parse(row.Cells(7).Text, CultureInfo.InvariantCulture)
            costoUnitario = Double.Parse(row.Cells(8).Text, CultureInfo.InvariantCulture)
            montoItem = Double.Parse(row.Cells(9).Text, CultureInfo.InvariantCulture)
            campanaItem = Double.Parse(row.Cells(10).Text, CultureInfo.InvariantCulture)
            tipoCambioItem = Double.Parse(row.Cells(15).Text, CultureInfo.InvariantCulture)
            avance = Double.Parse(row.Cells(20).Text, CultureInfo.InvariantCulture)

            pInsertarRegistro(row.Cells(12).Text, row.Cells(13).Text, IIf(Mid(row.Cells(11).Text, 1, 1) = "I" Or Mid(row.Cells(11).Text, 1, 1) = "F" Or Mid(row.Cells(11).Text, 1, 1) = "C", row.Cells(14).Text, "000001"), IIf(Mid(row.Cells(11).Text, 1, 1) = "M" Or Mid(row.Cells(11).Text, 1, 1) = "R", row.Cells(14).Text, "000001"), IIf(Mid(row.Cells(11).Text, 1, 1) = "H", row.Cells(14).Text, "00000001"), cantidad, costoUnitario, montoItem, campanaItem, IIf(cboMoneda.SelectedIndex = 0, False, True), tipoCambioItem, txtCicloPeriodo.Text, Mid(row.Cells(11).Text, 1, 1), CDate(row.Cells(0).Text), row.Cells(19).Text, IdProveedor, sObservaciones, avance)
        Next
    ...
    Private Sub pInsertarRegistro(ByVal IdZonaTrabajo As String, ByVal IdActividad As String, ByVal IdProducto As String, ByVal IdMaquina As String, ByVal IdPersonal As String, ByVal cantidad As Double, ByVal CostoUnitario As Double, ByVal MontoStandar As Double, ByVal campana As Double, ByVal tc As Short, ByVal TipoCambio As Double, ByVal numeroparte As String, ByVal tipocosto As String, ByVal fecha As Date, ByVal IdCosto As String, ByVal IdProveedor As String, ByVal sObservaciones As String, ByVal Avance As String)
        ...
        Else
            IdCosto = Session("FrmCostosProductos_Codigo").ToString()
    ...
    Private Sub Limpia()
        ...
        TotCantidad.Text = ""
        TotMonto.Text = ""
        Session("FrmCostosProductos_Datatable") = Nothing
    End Sub
    ...
    Private Sub CargarCombo(ByRef ssql As String, ByRef idField As String, ByRef Desc As String, ByRef Cbo As DropDownList)
        ...
        While Not adoTabla.EOF
            ...
            Dim STRID As String = Session("FrmCostosProductos_STRID")
            If adoTabla.Fields(idField).Value = STRID Then intOrden = i
            i = i + 1
            adoTabla.MoveNext()
        End While

        Session("FrmCostosProductos_MatrizPC") = MatrizPC
        Session("FrmCostosProductos_MatrizPTC") = MatrizPTC
        Session("FrmCostosProductos_MatrizCt") = MatrizCt
        Session("FrmCostosProductos_MatrizAx") = MatrizAx
        Session("FrmCostosProductos_MatrizCa") = MatrizCa
        Session("FrmCostosProductos_MatrizTd") = MatrizTd
        Session("FrmCostosProductos_MatrizCc") = MatrizCc
        Session("FrmCostosProductos_MatrizMq") = MatrizMq
        Session("FrmCostosProductos_MatrizCp") = MatrizCp
        Session("FrmCostosProductos_MatrizPr") = MatrizPr
        Session("FrmCostosProductos_MatrizAC") = MatrizAC
        Session("FrmCostosProductos_MatrizCm") = MatrizCm
        Session("FrmCostosProductos_MatrizProv") = MatrizProv
    ...
    Private Sub pSumaMontos()
        ...
        dt = Session("FrmCostosProductos_Datatable")

        For Each row As DataRow In dt.Rows
            dblSuma = dblSuma + Convert.ToDecimal(IIf(row.Item(9) = "", 0, row.Item(9)), CultureInfo.InvariantCulture)
        Next
    ...
    Private Sub AddRecord()
        ...
        Dim MatrizCt() As Object = Session("FrmCostosProductos_MatrizCt")
        Dim MatrizCp() As Object = Session("FrmCostosProductos_MatrizCp")
        Dim strIdCosto As String = Session("FrmCostosProductos_IdCosto")
        ...
        dr.Item(Resource1.str3005) = cboCodanx.Text

        dr.Item(7) = montoCantidad.ToString("###0.00")
        dr.Item(8) = montoCUnitario.ToString("###0.00")
        dr.Item(9) = (montoCantidad * montoCUnitario).ToString("###0.00")
        dr.Item(10) = IIf(String.IsNullOrEmpty(txtCampana.Text), "0", txtCampana.Text)
        dr.Item("Proveedor") = cboProveedor.Text    '10
        dr.Item("TipoCosto") = MatrizAC(cboTipoCosto.SelectedIndex) '11

        Select Case Mid(dr.Item("TipoCosto"), 1, 1)
            Case "O"
                dr.Item("TipoCosto") = Resource1.str538
            Case "I"
                dr.Item("TipoCosto") = Resource1.str2012
            Case "F"
                dr.Item("TipoCosto") = "F" & Resource1.str62
            Case "C"
                dr.Item("TipoCosto") = "C" & Resource1.str11010
            Case "M"
                dr.Item("TipoCosto") = Resource1.str401
            Case "R"
                dr.Item("TipoCosto") = Resource1.str3012
            Case "H"
                dr.Item("TipoCosto") = "H" & Resource1.str4001
        End Select
        ...
        Select Case Mid(dr.Item("TipoCosto"), 1, 1)
            Case "I"
                dr.Item(14) = MatrizCc(cboCodanx.SelectedIndex)
            Case "F"
                dr.Item(14) = MatrizCc(cboCodanx.SelectedIndex)
            Case "C"
                dr.Item(14) = MatrizCc(cboCodanx.SelectedIndex)
            Case "M"
                dr.Item(14) = MatrizMq(cboCodanx.SelectedIndex)
            Case "R"
                dr.Item(14) = MatrizCp(cboCodanx.SelectedIndex)
            Case "H"
                dr.Item(14) = MatrizPr(cboCodanx.SelectedIndex)
        End Select

        dr.Item(15) = txtTC.Text
        dr.Item(16) = CStr(cboMoneda.SelectedIndex)
        dr.Item(17) = "NA0"
        dr.Item(18) = "COSTIN"
        dr.Item(19) = strIdCosto
        dr.Item(20) = IIf(String.IsNullOrEmpty(txtAvance.Text.Trim()), "0", txtAvance.Text.Trim())
        dt.Rows.Add(dr)

        Session("FrmCostosProductos_PreviousSelectedIndex") = -1
        Session("FrmCostosProductos_Datatable") = dt
    ...
    Function getRecord() As Boolean
        Dim StrIdenlace As String = Session("FrmCostosProductos_Codigo")
        ...
        If Not RS.EOF Then
            ...
            While Not RS.EOF
                ...
                dr.Item("Proveedor") = RS.Fields("ProvDescripcion").Value

                Select Case RS.Fields("tipo_costo").Value
                    Case "M", "R"
                        dr.Item(6) = RS.Fields("maqdes").Value
                    Case "H"
                        dr.Item(6) = RS.Fields("perdes").Value
                    Case "I"
                        dr.Item(6) = RS.Fields("prodes").Value
                    Case "O"
                        dr.Item(6) = ""
                End Select
                dr.Item(Resource1.str3005) = RS.Fields("prodes").Value

                dr.Item(7) = Convert.ToDecimal(RS.Fields("cantidad").Value).ToString("###0.00")
                ...
                dr.Item(8) = amount.ToString("###0.00")
                ...
                dr.Item(9) = amount2.ToString("###0.00")

                dr.Item(10) = RS.Fields("campana").Value
                tipoCosto = RS.Fields("tipo_costo").Value

                dr.Item(11) = RS.Fields("tipo_costo").Value

                Select Case Mid(dr.Item(11), 1, 1)
                    Case "O"
                        dr.Item(11) = Resource1.str538
                    Case "I"
                        dr.Item(11) = Resource1.str2012
                    Case "F"
                        dr.Item(11) = "F" & Resource1.str62
                    Case "C"
                        dr.Item(11) = "C" & Resource1.str11010
                    Case "M"
                        dr.Item(11) = Resource1.str401
                    Case "R"
                        dr.Item(11) = Resource1.str3012
                    Case "H"
                        dr.Item(11) = "H" & Resource1.str4001
                End Select

                dr.Item(12) = RS.Fields("id_zonatrabajo").Value
                dr.Item(13) = RS.Fields("id_actividad").Value

                Select Case Mid(dr.Item(11), 1, 1)
                    Case "I"
                        dr.Item(14) = RS.Fields("id_producto").Value
                    Case "M", "R"
                        dr.Item(14) = RS.Fields("id_maquinaria").Value
                    Case "H"
                        dr.Item(14) = RS.Fields("id_personal").Value
                    Case Else
                        dr.Item(14) = RS.Fields("id_producto").Value
                End Select

                dr.Item(15) = RS.Fields("Tipo_Cambio").Value
                dr.Item(16) = IIf(RS.Fields("tc").Value = 0, 0, 1)
                dr.Item(17) = RS.Fields("id_etapa").Value
                dr.Item(18) = RS.Fields("id_cultivo").Value
                dr.Item(19) = RS.Fields("id_costo").Value
                dr.Item(20) = RS.Fields("id_enlace").Value.ToString().Trim()
            ...
            Dim MatrizProv() As Object = Session("FrmCostosProductos_MatrizProv")
            'Session.Add("FrmCostosProductos_provDesc") = provDesc
