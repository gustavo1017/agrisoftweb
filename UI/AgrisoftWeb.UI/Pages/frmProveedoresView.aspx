<%@ Page Title="" Language="vb" AutoEventWireup="false" CodeBehind="frmProveedoresView.aspx.vb" Inherits="AgrisoftWeb.UI.frmProveedoresView" MasterPageFile="~/Pages/MasterAgrisoftWeb.Master" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PagesContent" runat="server">
     <div class="form-row">
        <div class="col-12">
            <div id="Div2" runat="server" class="alert alert-info">
                <b><asp:Label ID="Label3" runat="server" Text="Proveedores"></asp:Label></b>
            </div>
        </div>
    </div>
    <div style="padding-top: 20px">
        ...
        <div class="row" style="padding-top: 10px">
            <div id="Frame3" style="height: 350px; overflow: scroll; float: left; position: relative; left: 0;" class="col-sm-6">
        ...
        <asp:HiddenField ID="hdnStr38" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function verifySelection() {
            var selectionId = '<%= Session("frmProveedoresView_IdProveedor") %>';
        ...
        function showEditForm() {
            ...
            var modalPage = "frmproveedores.aspx?Action=EDIT";
            ...
            var $dialog = $('<div></div>').html('<iframe style="border: 0px; " src="' + modalPage + '" width="100%" height="100%"></iframe>').dialog({
                ...
                height: 290,
                width: 420,
                title: document.getElementById('<%=hdnStr38.ClientID%>').value,
                position: ['center', 20],
                //buttons:{
                //    btnName: function () {
                //        $(this).dialog("close");
        ...
        function showNewForm() {
            ...
            var modalPage = "frmproveedores.aspx?Action=NEW";
            var urlBase = location.href.substring(0, location.href.lastIndexOf("/") + 1);
            var url = urlBase + modalPage;
            var $dialog = $('<div></div>').html('<iframe style="border: 0px; " src="' + modalPage + '" width="100%" height="100%"></iframe>').dialog({
                autoOpen: false,
