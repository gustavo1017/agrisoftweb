...
Public Class CrIngresosAlmacen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgrisoftWeb.UI.CrIngresosAlmacen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrIngresosAlmacen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrIngresosAlmacen = New CrIngresosAlmacen()
        rpt.Site = Me.Site
        Return rpt
    End Function
