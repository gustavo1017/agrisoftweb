...
Public Class crZonaTrabajo3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgrisoftWeb.UI.crZonaTrabajo3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrZonaTrabajo3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crZonaTrabajo3 = New crZonaTrabajo3()
        rpt.Site = Me.Site
        Return rpt
    End Function
