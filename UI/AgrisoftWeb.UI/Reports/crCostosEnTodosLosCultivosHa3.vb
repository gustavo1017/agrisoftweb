...
Public Class crCostosEnTodosLosCultivosHa3
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crCostosEnTodosLosCultivosHa3.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgrisoftWeb.UI.crCostosEnTodosLosCultivosHa3.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DomainURL() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrCostosEnTodosLosCultivosHa3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCostosEnTodosLosCultivosHa3 = New crCostosEnTodosLosCultivosHa3()
        rpt.Site = Me.Site
        Return rpt
    End Function
