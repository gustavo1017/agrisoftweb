...
Public Class crActividades
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgrisoftWeb.UI.crActividades.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrActividades
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crActividades = New crActividades()
        rpt.Site = Me.Site
        Return rpt
    End Function
