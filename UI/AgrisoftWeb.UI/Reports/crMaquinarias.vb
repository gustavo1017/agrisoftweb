...
Public Class crMaquinarias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgrisoftWeb.UI.crMaquinarias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrMaquinarias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crMaquinarias = New crMaquinarias()
        rpt.Site = Me.Site
        Return rpt
    End Function
