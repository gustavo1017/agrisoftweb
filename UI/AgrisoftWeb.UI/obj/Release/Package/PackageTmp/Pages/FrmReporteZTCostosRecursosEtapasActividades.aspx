<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="MasterAgrisoftWeb.Master" CodeBehind="FrmReporteZTCostosRecursosEtapasActividades.aspx.vb" Inherits="AgrisoftWeb.UI.FrmReporteZTCostosRecursosEtapasActividades" %>
     ...
     <div class="form-row">
        <div class="col-12">
            <div id="Div2" runat="server" class="alert alert-info">
                <b><asp:Label ID="Label3" runat="server" Text="Reporte de Costos por Actividades"></asp:Label></b>
            </div>
        </div>
    </div>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <div class="form-row" style="padding-bottom: 8px">
                        ...
                        <div class="col-1">
                            <asp:DropDownList ID="cboMoneda" runat="server"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="form-row" style="padding-bottom: 8px">
                        <div style="padding-left: 30px; width: 100px;">
