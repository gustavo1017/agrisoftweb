<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmCostosProductos.aspx.vb" Inherits="AgrisoftWeb.UI.frmCostosProductos" EnableEventValidation="false" %>
    ...
    <script type="text/javascript">
        ...
        function setDatePickerControls() {
            ...
            $(".date").on("change", function () {
                ...
                $.ajax({
                    url: "frmCostosProductos.aspx/GetTipoCambio",
                    method: "POST",
        ...
        function verifySelection() {
            var selectionId = '<%= Session("frmCostosProductos_PreviousSelectedIndex") %>';
    ...
    <form id="form1" runat="server">
        <div style="padding-top: 10px">
            ...
            <div id="dvInfo" runat="server">
                <div class="form-row">
                    <div class="col-0" style="width: 70px; text-align: right">
                        <asp:Label ID="lblCultivo" runat="server" Text="Cultivo" CssClass="col-form-label-sm"></asp:Label>
                    </div>
                    <div class="col-2">
                        <asp:DropDownList ID="cboCultivo" runat="server" CssClass="form-control form-control-sm" OnSelectedIndexChanged="cboCultivo_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                    </div>
                    ...
                    <div class="col-3">
                        <asp:DropDownList ID="cboZonaTrabajo" runat="server" CssClass="form-control form-control-sm" OnSelectedIndexChanged="cboZonaTrabajo_SelectedIndexChanged" AutoPostBack="true" Width="220px"></asp:DropDownList>
                    </div>
                    <div class="col-0" style="width: 105px; text-align: right">
                        <asp:Label ID="lblCampana" runat="server" Text="Etapa" CssClass="col-form-label-sm"></asp:Label>
                    </div>
                    <div class="col-2">
                ...
                <div class="form-row">
                    <div class="col-0" style="width: 70px; text-align: right">
                        <asp:Label ID="lblEtapa" runat="server" Text="Etapa" CssClass="col-form-label-sm"></asp:Label>
                    </div>
                    <div class="col-2">
                        <asp:DropDownList ID="cboEtapa" runat="server" CssClass="form-control form-control-sm" OnSelectedIndexChanged="cboEtapa_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                    </div>
                    <div class="col-0" style="width: 130px; text-align: right">
                        <asp:Label ID="lblActividad" runat="server" Text="Actividad" CssClass="col-form-label-sm"></asp:Label>
                    </div>
                    <div class="col-3">
                        <asp:DropDownList ID="cboActividad" runat="server" CssClass="form-control form-control-sm" Width="220px"></asp:DropDownList>
                    </div>
                    <div class="col-0" style="width: 105px; text-align: right">
                        <asp:Label ID="Label2" runat="server" Text="Avance" CssClass="col-form-label-sm"></asp:Label>
                    </div>
                    <div class="col-2">
            ...
            <div class="form-row">
                ...
                <div class="col-1" style="text-align: right; padding-top: 10px">
                    <asp:Button ID="btnGrabar" runat="server" Text="Grabar" OnClick="btnGrabar_Click" OnClientClick="return ValidarGrabar();" CssClass="btn btn-primary btn-sm" Width="95px" />
                </div>
            </div>
        </div>
    </form>
