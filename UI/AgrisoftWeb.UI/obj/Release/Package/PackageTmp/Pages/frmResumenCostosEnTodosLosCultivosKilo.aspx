<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Pages/MasterAgrisoftWeb.Master" CodeBehind="frmResumenCostosEnTodosLosCultivosKilo.aspx.vb" Inherits="AgrisoftWeb.UI.frmResumenCostosEnTodosLosCultivosKilo" %>
    ...
    <div>
        ...
        <div class="col-12">
            <div id="Div2" runat="server" class="alert alert-info">
                <b><asp:Label ID="Label3" runat="server" Text="Resumen de Costos por Kilo"></asp:Label></b>
            </div>
        </div>
    </div>
