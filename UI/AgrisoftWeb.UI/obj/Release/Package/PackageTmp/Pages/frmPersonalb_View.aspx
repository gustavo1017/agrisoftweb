<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Pages/MasterAgrisoftWeb.Master" CodeBehind="frmPersonalb_View.aspx.vb" Inherits="AgrisoftWeb.UI.frmPersonalb_View" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PagesContent" runat="server">
     <div class="form-row">
        <div class="col-12">
            <div id="Div2" runat="server" class="alert alert-info">
                <b><asp:Label ID="Label3" runat="server" Text="Trabajadores"></asp:Label></b>
            </div>
        </div>
    </div>
    <div style="padding-top: 20px">
        <asp:Panel runat="server">
            ...
            <asp:DropDownList ID="cboFields" runat="server"></asp:DropDownList>
            <asp:TextBox ID="find" runat="server"></asp:TextBox>
            <asp:Button ID="btnBuscar" runat="server" Text="" OnClientClick="return validateSearch();" OnClick="btnBuscar_Click" />
        </asp:Panel>
        <div id="dvMessage" runat="server" class="alert alert-danger" visible="false">
            <asp:Label ID="lblResults" runat="server" Text=""></asp:Label>
        </div>
        <div class="row" style="padding-top: 10px">
            <div id="Frame3" style="width: 80%; height: 300px; overflow: scroll; float: left; position: relative; left: 0;" class="col-sm-10">
            ...
            <br />
            <div id="Frame4" style="float: right" class="col-sm-2">
        ...
        <asp:HiddenField ID="hdnStr4001" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function verifySelection() {
            var selectionId = '<%= Session("frmPersonalbView_IdPersonal") %>';
        ...
        function showEditForm() {
            ...
            var modalPage = "frmPersonalb.aspx?Action=EDIT";
            ...
            var $dialog = $('<div></div>').html('<iframe style="border: 0px; " src="' + modalPage + '" width="100%" height="100%"></iframe>').dialog({
                ...
                height: 480,
                width: 505,
                title: document.getElementById('<%=hdnStr4001.ClientID%>').value,
                position: ['center', 20],
                //buttons:{
                //    btnName: function () {
                //        $(this).dialog("close");
        ...
        function showNewForm() {
            ...
            var modalPage = "frmPersonalb.aspx?Action=NEW";
            var urlBase = location.href.substring(0, location.href.lastIndexOf("/") + 1);
            var url = urlBase + modalPage;
            var $dialog = $('<div></div>').html('<iframe style="border: 0px; " src="' + modalPage + '" width="100%" height="100%"></iframe>').dialog({
                autoOpen: false,
