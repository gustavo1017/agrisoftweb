<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Pages/MasterAgrisoftWeb.Master" CodeBehind="frmPlaneamiento_View.aspx.vb" Inherits="AgrisoftWeb.UI.frmPlaneamiento_View" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PagesContent" runat="server">
     <div class="form-row">
        <div class="col-12">
            <div id="Div2" runat="server" class="alert alert-info">
                <b><asp:Label ID="Label3" runat="server" Text="Planeamiento"></asp:Label></b>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        function showEditForm() {
            ...
            var w = $(window).width();
            var modalPage = "frmPlaneamiento.aspx?Action=EDIT";
        ...
        function showNewForm() {
            ...
            var w = $(window).width();
            var modalPage = "frmPlaneamiento.aspx?Action=NEW";
            var urlBase = location.href.substring(0, location.href.lastIndexOf("/") + 1);
            var url = urlBase + modalPage;
            var $dialog = $('<div></div>').html('<iframe style="border: 0px; " src="' + modalPage + '" width="100%" height="100%"></iframe>').dialog({
                autoOpen: false,
        ...
        function verifySelection() {
            var selectionId = '<%= Session("frmPlaneamiento_View_IdCosto") %>';
