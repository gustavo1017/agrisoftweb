<%@ Page Title="" Language="vb" AutoEventWireup="false" CodeBehind="frmCultivosView.aspx.vb" Inherits="AgrisoftWeb.UI.frmCultivosView" MasterPageFile="~/Pages/MasterAgrisoftWeb.Master" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PagesContent" runat="server">
     <div class="form-row">
        <div class="col-12">
            <div id="Div2" runat="server" class="alert alert-info">
                <b><asp:Label ID="Label3" runat="server" Text="Cultivos"></asp:Label></b>
            </div>
        </div>
    </div>
    <div style="padding-top: 20px">
        ...
        <asp:HiddenField ID="hdnStr5001" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function verifySelection() {
            var selectionId = '<%= Session("frmCultivosView_IdCultivo") %>';
        ...
        function showEditForm() {
            ...
            var modalPage = "frmCultivos.aspx?Action=EDIT";
            ...
            var $dialog = $('<div></div>').html('<iframe style="border: 0px; " src="' + modalPage + '" width="100%" height="100%"></iframe>').dialog({
                ...
                height: 290,
                width: 420,
                title: document.getElementById('<%=hdnStr5001.ClientID%>').value,
                position: ['center', 20],
                //buttons:{
                //    btnName: function () {
                //        $(this).dialog("close");
        ...
        function showNewForm() {
            ...
            var modalPage = "frmCultivos.aspx?Action=NEW";
            var urlBase = location.href.substring(0, location.href.lastIndexOf("/") + 1);
            var url = urlBase + modalPage;
            var $dialog = $('<div></div>').html('<iframe style="border: 0px; " src="' + modalPage + '" width="100%" height="100%"></iframe>').dialog({
                autoOpen: false,
