<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Pages/MasterAgrisoftWeb.Master" CodeBehind="frmReporteCostoTotalEnUnaZonaDeTrabajoPorRubrosAgroinperDetail.aspx.vb" Inherits="AgrisoftWeb.UI.frmReporteCostoTotalEnUnaZonaDeTrabajoPorRubrosAgroinperDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PagesContent" runat="server">
     <div class="form-row">
        <div class="col-12">
            <div id="Div2" runat="server" class="alert alert-info">
                <b><asp:Label ID="Label3" runat="server" Text="Reporte de costos por Recursos Detallado"></asp:Label></b>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        function validateSearch() {
            ...
            {
                var dateFrom = $("#<%=dtfechamin.ClientID%>").val();
                var dateTo = $("#<%=dtfechamax.ClientID%>").val();

                if(dateFrom == '' || dateTo == '')
                {
                    alert('Seleccione por favor fechas válidas');
                    return false;
                }
            }
        }
