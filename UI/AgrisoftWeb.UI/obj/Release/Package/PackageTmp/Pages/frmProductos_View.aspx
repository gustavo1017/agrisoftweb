<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Pages/MasterAgrisoftWeb.Master" CodeBehind="frmProductos_View.aspx.vb" Inherits="AgrisoftWeb.UI.frmProductos_View" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PagesContent" runat="server">
     <div class="form-row">
        <div class="col-12">
            <div id="Div2" runat="server" class="alert alert-info">
                <b><asp:Label ID="Label3" runat="server" Text="Productos"></asp:Label></b>
            </div>
        </div>
    </div>
    <div style="padding-top: 20px">
        ...
        <div class="row" style="padding-top: 10px">
            <div id="Frame3" style="height: 350px; overflow: scroll; float: left; position: relative; left: 0;" class="col-sm-10">
        ...
        <asp:HiddenField ID="hdnStr101" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function verifySelection() {
            var selectionId = '<%= Session("frmProductosView_IdProducto") %>';
        ...
        function showEditForm() {
            ...
            var modalPage = "frmProductos.aspx?Action=EDIT";
            ...
            var $dialog = $('<div></div>').html('<iframe style="border: 0px; " src="' + modalPage + '" width="100%" height="100%"></iframe>').dialog({
                ...
                height: 370,
                width: 425,
                title: document.getElementById('<%=hdnStr101.ClientID%>').value,
                position: ['center', 20],
        ...
        function showNewForm() {
            ...
            var modalPage = "frmProductos.aspx?Action=NEW";
            var urlBase = location.href.substring(0, location.href.lastIndexOf("/") + 1);
            var url = urlBase + modalPage;
            var $dialog = $('<div></div>').html('<iframe style="border: 0px; " src="' + modalPage + '" width="100%" height="100%"></iframe>').dialog({
                autoOpen: false,
